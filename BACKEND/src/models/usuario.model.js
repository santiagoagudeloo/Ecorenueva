// 📁 models/usuario.model.js (versión corregida + verificarPassword)
...
const getById = async (id) => {
    const [rows] = await pool.query(
        'SELECT id, nombre, correo, puntos FROM usuarios WHERE id = ?', 
        [id]
    );
    return rows[0]; // undefined si no existe
};

// ✅ NUEVA FUNCIÓN: Verificar contraseña actual
...
module.exports = { 
    ...
    login, 
    getById, 
    verificarPassword,  // ✅ Exportar la nueva función
    update, 
    updatePassword, 
    remove 
};